...
<td>
  <img width="40px" src="<%= imgSrc %>">
												...
												<td>
  <%= product.getSubcategory() != null ? product.getSubcategory().getSub_name() : "없음" %>
</td>
												...
												<td>
													<%
														List<ProductColor> colorList = product.getProductColorList();
														StringBuffer sb = new StringBuffer();
														
														for (ProductColor color : colorList){
															sb.append(color.getColor().getColor_name());
															sb.append(", ");
														}
												...
												<td>
													<%
														List<ProductSize> sizeList = product.getProductSizeList();
														sb.delete(0, sb.length()); // 기존 스트링 지우기
														
														for (ProductSize size : sizeList){
															sb.append(size.getSize().getSize_name());
															sb.append(", ");
														}
														out.print(sb.toString());
													%>
